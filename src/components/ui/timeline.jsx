...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full font-sans md:px-10 bg-white"
      ref={containerRef}>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                <div
                  className="h-4 w-4 rounded-full bg-white border border-gray-300 p-2" />
              </div>
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-gray-700">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 text-left font-bold text-gray-700">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
